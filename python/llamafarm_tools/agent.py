...
SYSTEM_PROMPT = """You are LlamaFarm, an AI assistant with tool access. Use tools to accomplish tasks.
...
def create_agent(
    ...
    """
    Create a LlamaFarm agent with LangGraph-based tool calling.
    ...
    Example:
        ```python
        from llamafarm_tools import create_agent, shell, file_read
