"""
CLI entry point for llamafarm-tools.
"""
...
DEFAULT_SYSTEM_PROMPT = """You are LlamaFarm, an AI assistant with full system access. Use tools to accomplish tasks.
...
def _build_parser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(
        description="LlamaFarm Tools - LangGraph-based tool calling for LLMs"
    )
    parser.add_argument(
        "message",
        nargs="*",
...
def main(argv: list[str] | None = None):
    ...
    if args.interactive:
        print("LlamaFarm Tools CLI (Interactive Mode)")
