"""
Discord bot integration for LlamaFarm.
"""
...
class DiscordBot:
    """
    Discord bot powered by LlamaFarm agent with LangGraph tool calling.
    ...
    def __init__(
        ...
        if not DISCORD_AVAILABLE:
            raise ImportError(
                ...
                "Install with: pip install llamafarm-tools[discord]"
            )
    ...
    def _setup_events(self):
        @self.client.event
        async def on_ready():
            print(f"LlamaFarm Discord Bot ready: {self.client.user}")
