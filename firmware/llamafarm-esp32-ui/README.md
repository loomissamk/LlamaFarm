# LlamaFarm ESP32 UI Firmware

Slint-based graphical UI firmware scaffold for LlamaFarm edge scenarios on ESP32.
...
```bash
cd firmware/llamafarm-esp32-ui
cargo build --release
...
3. Connect UI state with LlamaFarm edge/runtime messaging
...
- [LlamaFarm Hardware Design](../../docs/hardware-peripherals-design.md)
