...
use llamafarm::providers::compatible::AuthStyle;
use llamafarm::providers::traits::{ChatMessage, ChatResponse, ToolCall};
...
fn provider_construction_with_different_names() {
    use llamafarm::providers::compatible::OpenAiCompatibleProvider;
