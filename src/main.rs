...
List, validate, and inspect SOPs stored in the workspace sops directory. \
Each SOP is a directory containing SOP.toml (metadata + triggers) and \
SOP.md (procedure steps).

Examples:
  llamafarm sop list
  llamafarm sop validate
  llamafarm sop validate --name my-sop
  llamafarm sop show my-sop")]
    Sop {
        #[command(subcommand)]
