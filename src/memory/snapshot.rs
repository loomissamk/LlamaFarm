...
const SNAPSHOT_HEADER: &str = "# 🧠 LlamaFarm Memory Snapshot\n\n\
    > Auto-generated by LlamaFarm. Do not edit manually unless you know what you're doing.\n\
...
mod tests {
    ...
    fn parse_snapshot_basic() {
        let input = r#"# 🧠 LlamaFarm Memory Snapshot

> Auto-generated by LlamaFarm.
...
I am LlamaFarm, a self-preserving AI agent.
...
"#;
    ...
    fn parse_snapshot_empty() {
        let input = "# 🧠 LlamaFarm Memory Snapshot\n\n> Nothing here.\n";
        let entries = parse_snapshot(input);
