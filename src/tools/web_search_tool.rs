...
impl Tool for WebSearchTool {
    ...
    fn description(&self) -> &str {
        "Search the web for information. Returns relevant search results with titles, URLs, and descriptions. Use this to find current information, news, or research topics. When web_fetch is available, use it to read the full content of the most relevant URLs before answering."
    }
