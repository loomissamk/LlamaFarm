...
const OTP_ISSUER: &str = "LlamaFarm";
...
impl OtpValidator {
    pub fn from_config(
        ...
        let secret_path = secret_file_path(llamafarm_dir);
...
pub fn secret_file_path(llamafarm_dir: &Path) -> PathBuf {
    llamafarm_dir.join(OTP_SECRET_FILE)
}
