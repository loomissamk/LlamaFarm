//! Example: Implementing a custom Memory backend for LlamaFarm
//!
...
// ── Re-define the trait types (in your app, import from llamafarm::memory) ──
...
async fn main() -> anyhow::Result<()> {
    ...
    println!("🧠 LlamaFarm Memory Demo — InMemoryBackend\n");
