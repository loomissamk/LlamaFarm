//! # LlamaFarm Robot Kit
//!
//! A standalone robotics toolkit that integrates with LlamaFarm for AI-powered robots.
//!
//! ## Features
//!
...
//! ```text
//! ┌─────────────────────────────────────────────────────────┐
//! │  LlamaFarm AI Brain (or any controller)                  │
...
//!
//! ```rust,ignore
//! use llamafarm_robot_kit::{RobotConfig, DriveTool, SafetyMonitor, SafeDrive};
//! use std::sync::Arc;
//!
//! #[tokio::main]
//! async fn main() {
...
//! ## Standalone Usage
//!
//! This crate can be used independently of LlamaFarm. It defines its own
//! `Tool` trait that is compatible with LlamaFarm's but doesn't require it.
//!
//! ## Safety
//!
