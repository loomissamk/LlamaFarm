...
LlamaFarm có rate limiting (20 actions/hour) nhưng chưa có giới hạn tài nguyên. Một agent bị lỗi lặp vòng có thể:
...
Tự động tạo cgroup cho llamafarm với các giới hạn.
