...
|---------|-----------|--------------|--------|
| **LlamaFarm cơ bản** | 3.4MB | <5MB | ✅ Hiện tại |
...
| Phần cứng | RAM | LlamaFarm (cơ bản) | LlamaFarm (full security) | Trạng thái |
|----------|-----|-----------------|--------------------------|--------|
...
**Ngay cả với full security, LlamaFarm chỉ dùng <5% RAM trên board $10.**

---

## 5. Tính hoán đổi: mọi thứ vẫn pluggable

### Cam kết chính của LlamaFarm: hoán đổi bất kỳ thứ gì
