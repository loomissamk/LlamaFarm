...
Cách cài đặt và khởi tạo LlamaFarm nhanh nhất.
...
Mặc định là **chỉ ứng dụng** (build/cài LlamaFarm), yêu cầu Rust toolchain sẵn có.
...
Lệnh này build image LlamaFarm cục bộ và chạy thiết lập trong container, lưu config/workspace vào `./.llamafarm-docker`.
