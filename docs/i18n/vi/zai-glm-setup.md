...
LlamaFarm hỗ trợ các model GLM của Z.AI thông qua các endpoint tương thích OpenAI.
Hướng dẫn cấu hình thực tế theo provider hiện tại của LlamaFarm.

## Tổng quan

LlamaFarm hỗ trợ sẵn các alias và endpoint Z.AI sau đây:
