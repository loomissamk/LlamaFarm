# Локализованный bridge: Proxy Agent Playbook
...
- [H3 · 1.1 Proxy only LlamaFarm internal traffic](../../proxy-agent-playbook.md#1-1-proxy-only-llamafarm-internal-traffic)
...
- [H2 · 4. Mode A — Proxy Only for LlamaFarm Internals](../../proxy-agent-playbook.md#4-mode-a-proxy-only-for-llamafarm-internals)
