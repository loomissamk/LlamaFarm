...
- `tool_dispatcher`: Στρατηγική dispatch των εργαλείων. Με `auto`, τα τοπικά μοντέλα Ollama που δεν χρησιμοποιούν cloud-routed model IDs (για παράδειγμα `glm-5:cloud` ή `devstral-2:123b-cloud`) προτιμούν XML tool mode, επειδή αυτή η διαδρομή είναι σήμερα πιο αξιόπιστη από το native function-calling για μικρότερα local μοντέλα σε αυτό το runtime. Ορίστε `native` για να το παρακάμψετε.
