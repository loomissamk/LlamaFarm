...
Αυτός ο οδηγός περιγράφει λύσεις για κοινά ζητήματα εγκατάστασης και εκτέλεσης του LlamaFarm.
...
llamafarm doctor
```
Ελέγξτε τις ρυθμίσεις στο `~/.llamafarm/config.toml`:
...
Ελέγξτε την κατάσταση μέσω του LlamaFarm CLI:
```bash
