...
- **Κοινό**: Διαχειριστές συστημάτων και συντηρητές που λειτουργούν το LlamaFarm σε εταιρικά ή περιορισμένα δίκτυα.
...
### 1.1 Proxy μόνο για το LlamaFarm (Internal Traffic)

- **Περιγραφή**: Διαμεσολάβηση μόνο για την εσωτερική κίνηση του δαίμονα.
- **Εμβέλεια (Scope)**: `llamafarm`.
...
|:---|:---|:---:|:---|
| `llamafarm` | Εσωτερικοί HTTP clients | Όχι | Αποφυγή παρενεργειών στο σύστημα. |
...
### Λειτουργία Α: Εσωτερική Διαμεσολάβηση (LlamaFarm only)
