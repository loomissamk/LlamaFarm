# Passerelle de localisation: Nucleo Setup
...
- [H3 · 1.2 Flash via LlamaFarm](../../nucleo-setup.md#1-2-flash-via-llamafarm)
...
- [H2 · Phase 3: Configure LlamaFarm](../../nucleo-setup.md#phase-3-configure-llamafarm)
