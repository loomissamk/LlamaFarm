...
Options:
    ...
    --repo OWNER/NAME   Repository (default: llamafarm-labs/llamafarm)
...
def parse_args():
    ...
    parser.add_argument(
        "--repo",
        default="llamafarm-labs/llamafarm",
        help="Repository in OWNER/NAME format (default: llamafarm-labs/llamafarm)",
    )
